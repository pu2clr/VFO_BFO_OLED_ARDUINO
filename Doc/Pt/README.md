...
4. [Esquema Elétrico](/Doc/Pt#esquema-elétrico)
  1.  [Si5351A](/Doc/Pt#si5351a)
	2. [OLED Display SSD1306 - 128 x 64/0.96](/Doc/Pt#oled-display-ssd1306---128-x-64096)
	3. [Endoder](/Doc/Pt#encoder)
5. [Sobre o programa Arduino](/Doc/Pt#sobre-o-esquema-e-conexões)
  1. [Calibração do Si5351A](/Doc/Pt#calibração-do-si5351a)
	2. [Informações sobre a configuração do VFO e BFO](/Doc/Pt#informações-sobre-a-configuração-do--vfo-e-bfo)
	3. [Pinos do Arduino para os botões Encoder, Band, Step e Switch VFO/BFO](/Doc/Pt#pinos-do-arduino-para-os-botões-encoder-band-step-e-switch-vfobfo)
	4.  [Interrupções externas](/Doc/Pt#interrupções-externas)
